...
description: Describes how users authenticate API requests using unified API keys for Investigator and ATI.
---
## Getting Access
...
If you are using Investigator, you can obtain and manage your key from the “[My API](https://i.threatbook.io/my-api)” page. If you are using ATI, please use the “[API Console](https://ati.threatbook.io/apiconsole)” page.
