...
- **Industry of Target HQ (`industry_of_target_hq`)**: The registered corporate sector of the victim's headquarters.
...
- **Target HQ Region Code (`hq_region_code`)**: Registered country code of the victim's headquarters.
